...
#align(center)[
  ...
  #linebreak()
  运动控制算法工程师（强化学习方向） · 北京市 · gaosongdeng\@163.com · 138XXXX8899
]

== 基本信息
- 学校：北京理工大学；学历：本科
- GitHub：#link("https://github.com/gaosongdeng-rl")[github.com/gaosongdeng-rl]
- 求职意向：运动控制算法工程师（强化学习方向）

== 教育背景
*北京理工大学* · 机器人工程本科 · 2020.09 - 2024.06
