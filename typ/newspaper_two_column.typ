...
#align(center)[
  #text(1.9em, weight: "bold")[高松灯]
  #linebreak()
  运动控制算法工程师（强化学习方向） · gaosongdeng\@163.com · 138XXXX8899 · 北京市
]
...
#columns(2, gutter: 14pt)[
  ...
  - 基于Isaac Gym搭建训练环境，优化PPO奖励函数，越障成功率提升35%
  - 域随机化+系统辨识优化实机迁移，动作误差从12%降至5%
  - 负责RL+前馈复合控制中的关节力矩模块，动态行走能耗降低18%

  == 项目经历
  机器人RL动态步态生成与抗扰动控制（算法负责人，2023.03 - 2023.06）
  - 设计分层奖励函数，训练效率提升40%
  - 15°斜坡与5cm凸起砂石路稳定性达92%，较传统方案提升45%

  人形机器人AMP的人体运动复刻与泛化（核心开发，2022.09 - 2023.02）
  - 处理1000+帧动捕数据，动作复刻相似度达95%
  - 0.2-0.8摩擦系数地面成功率从70%提升至90%
